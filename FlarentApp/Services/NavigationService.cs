...
namespace FlarentApp.Services
{
    public static class NavigationService
    {
        ...
        internal static void Initialize(SplitView splitView, Frame rightFrame)
        {
        ...
        public static async Task OpenInDialog(Type pageType, object parameter = null, NavigationTransitionInfo infoOverride = null, string title = null)
        {
            var dialog = ShellContentDialog.Create(pageType, parameter, infoOverride,title);
